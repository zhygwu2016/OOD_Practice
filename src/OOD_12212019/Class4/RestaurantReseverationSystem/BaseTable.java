...
import static Class4.RestaurantReseverationSystem.TableState.*;
...
public abstract class BaseTable {
    ...
    private final Class4.RestaurantReseverationSystem.TableType tableType;
    ...
    private final List<Class4.RestaurantReseverationSystem.ITableEventListener> tableEventListeners;

    //The current state of this table
    private Class4.RestaurantReseverationSystem.TableState state;
     ...
     */
    public BaseTable(@NotNull final String id,@NotNull final Class4.RestaurantReseverationSystem.TableType tableType){
        this.tableId = id;
    ...
    * */
     ...
     */
    public void registerListener(final Class4.RestaurantReseverationSystem.ITableEventListener tableEventListener){
     ...
     */
    public void deregisterListener(final Class4.RestaurantReseverationSystem.ITableEventListener tableEventListener){
     ...
     */
    private void notifyListener(final String tableId, final Class4.RestaurantReseverationSystem.TableState fromState, final Class4.RestaurantReseverationSystem.TableState toTableState){
        for(Class4.RestaurantReseverationSystem.ITableEventListener tableEventListener : tableEventListeners){
    ...
    public Class4.RestaurantReseverationSystem.TableType getTableType(){
        return tableType;
    }

    public Class4.RestaurantReseverationSystem.TableState getState(){
        return state;
    }
