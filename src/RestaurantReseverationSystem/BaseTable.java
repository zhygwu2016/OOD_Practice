...
import static RestaurantReseverationSystem.TableState.*;
...
public abstract class BaseTable {
    ...
    private final RestaurantReseverationSystem.TableType tableType;
    ...
    private final List<RestaurantReseverationSystem.ITableEventListener> tableEventListeners;

    //The current state of this table
    private RestaurantReseverationSystem.TableState state;
     ...
     */
    public BaseTable(@NotNull final String id,@NotNull final RestaurantReseverationSystem.TableType tableType){
        this.tableId = id;
     ...
     */
    public void registerListener(final RestaurantReseverationSystem.ITableEventListener tableEventListener){
     ...
     */
    public void deregisterListener(final RestaurantReseverationSystem.ITableEventListener tableEventListener){
     ...
     */
    private void notifyListener(final String tableId, final RestaurantReseverationSystem.TableState fromState, final RestaurantReseverationSystem.TableState toTableState){
        for(RestaurantReseverationSystem.ITableEventListener tableEventListener : tableEventListeners){
    ...
    public RestaurantReseverationSystem.TableType getTableType(){
        return tableType;
    }

    public RestaurantReseverationSystem.TableState getState(){
        return state;
    }
